...
const styles: Record<string, React.CSSProperties> = {
  ...
  overlay: {
    ...
    paddingBottom:
      "max(clamp(12px,3vw,24px), env(safe-area-inset-bottom, 12px))",
    background:
      "linear-gradient(180deg, rgba(10,20,50,0.10), rgba(10,20,50,0.10))",
  ...
  card: {
    ...
    padding:
      "clamp(16px, 3.2vw, 24px) clamp(16px, 3.2vw, 22px) clamp(14px, 2.6vw, 20px)",
